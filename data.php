		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="col-md-12">
					...
					<div style="padding-bottom: 20px;">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Magnam voluptatem qui autem tempore voluptate, sed eius officiis saepe ipsum quibusdam ducimus excepturi minus, enim odit asperiores quo cum facilis impedit?</div>
					<div style="font-size: 20px;"><label>Pertanyaan ke 2<label></div>
					<div style="padding-bottom: 20px;">Lorem ipsum dolor sit amet consectetur adipisicing elit. Repudiandae, voluptas voluptatibus? Quis rerum, ad provident delectus facere voluptas odio minus voluptatibus animi quia repudiandae? Dolor delectus eligendi molestiae cum veniam.</div>
					<div style="font-size: 20px;"><label>Pertanyaan ke 3<label></div>
					<div style="padding-bottom: 20px;">Lorem ipsum dolor sit amet consectetur adipisicing elit. Repudiandae, voluptas voluptatibus? Quis rerum, ad provident delectus facere voluptas odio minus voluptatibus animi quia repudiandae? Dolor delectus eligendi molestiae cum veniam.</div>
					<div style="font-size: 20px;"><label>Pertanyaan ke 4<label></div>
					<div style="padding-bottom: 20px;">Lorem ipsum dolor sit amet consectetur adipisicing elit. Repudiandae, voluptas voluptatibus? Quis rerum, ad provident delectus facere voluptas odio minus voluptatibus animi quia repudiandae? Dolor delectus eligendi molestiae cum veniam.</div>
					<div style="font-size: 20px;"><label>Pertanyaan ke 5<label></div>
					<div style="padding-bottom: 20px;">Lorem ipsum dolor sit amet consectetur adipisicing elit. Repudiandae, voluptas voluptatibus? Quis rerum, ad provident delectus facere voluptas odio minus voluptatibus animi quia repudiandae? Dolor delectus eligendi molestiae cum veniam.</div>
				</div>
			</div>
		</div>
